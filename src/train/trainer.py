...
from src.model.reccurent_attention import RecurrentAttention
from src.utils.utilities import AverageMeter
...
class Trainer:
    ...
    def __init__(self, config, data_loader):
        ...
        if config.use_gpu and torch.cuda.is_available():
            ...
            self.logger.debug("using gpu device to train.")
        else:
            self.device = torch.device("cpu")
            self.logger.debug("using cpu device to train.")
