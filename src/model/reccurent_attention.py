...
from src.model.network import RecurrentNetwork, ActionNetwork, BaselineNetwork, GlimpseNetwork, LocationNetwork
...
class RecurrentAttention(nn.Module):
    ...
    def __init__(
        ...
        self.rnn = RecurrentNetwork(hidden_size, hidden_size)
